...
MenuData.RegisteredTypes['default'] = {
    open  = function(namespace, name, data,setnui)
        SendNUIMessage({
            menubase_action = 'openMenu',
            menubase_namespace = namespace,
            menubase_name = name,
            menubase_data = data
        }) 
		if setnui then
...
--==================================  SHARE FUNCTIONS =========================================
AddEventHandler('rs_crafting:getData', function(cb)
    cb(MenuData)
end)
--==================================  SHARE FUNCTIONS =========================================
